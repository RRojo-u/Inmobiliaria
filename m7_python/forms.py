...
class InmuebleForm(forms.Form):
    ...
    numero_estacionamiento = forms.CharField(label= 'Número de estacionamientos', max_length= 100)
    precio_mensual = forms.IntegerField(label= 'Precio')

class InmueblesUpdateForm(forms.ModelForm):
    class Meta:
        model = Inmuebles
        fields = ['nombre_inmueble', 'descripcion', 'm2_construido', 'm2_terreno', 'numero_estacionamiento', 'numero_banos', 'numero_hab', 'direccion', 'precio_mensual']
        labels = {
            'nombre_inmueble':'Nombre Inmueble',
            'descripcion':'Descripción',
            'm2_construido':'M2 Construido',
            'm2_terreno':'M2 Terreno',
            'numero_estacionamiento':'Núm. de estacionamientos',
            'numero_banos':'Núm. de baños',
            'numero_hab':'Núm. de habitaciones',
            'direccion':'Dirección',
